...
const CustomerRegistration = () => {
  ...
  const getcity = () => {
    axios.get("http://localhost:8080/allcities").then((res) => {
      setCity(res.data);
      //console.log(city);
    });
  };
  ...
  const getarea = (id) => {
    ...
    axios.get("http://localhost:8080/getareabyid?cityid=" + id).then((res) => {
      setArea(res.data);
      console.log(area);
    });
  };
          ...
          <div class="card-body">
            <form>
              <table>
                ...
                <Button type="submit" class="btn-primary" onClick={saveUser}>
                  Register
                </Button>
              </table>
            </form>
