...
function Aboutus(){
    ...
    <div className="container">
        ...
        <p>
          <h4>Mentor - CDAC-Kochi</h4><br/>
          {/*<img src={background}/>*/}
        </p>
        </marquee>
        {/*<marquee width="60%" direction="up" height="300px"> </marquee>*/}
      <b>
        <p>Member 1 - Amit Nehete</p> 
        <p>Member 2 - Abhinav Tongale</p>
        <p>Member 3 - Khileshwari Firke</p>
        <p>Member 4 - Yatish Chaudhari</p>
        <p>Member 5 - Ajinkya Survase</p>
        <p>Member 6 - Aniket Shingane</p>
        </b>
